...
class BalanceStatReferenceDrawer : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        // Calculate rects
        var targetRect = new Rect(position.x, position.y, 120, position.height);
        var functionRect = new Rect(position.x + 125, position.y, position.width - 125, position.height);
