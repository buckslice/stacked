Shader "Custom/OutlinedShieldVF"
{
	Properties
	{
		...
		_OutlineDistance("OutlineDistance", Range(0.0,1.0)) = 0.5
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
				...
				fixed4 _Color;
				fixed _OutlineDistance;

				v2f vert(appdata v)
				{
					v2f o;
					o.vertex = UnityObjectToClipPos(v.vertex + _OutlineDistance * v.normal);
					return o;
				}
